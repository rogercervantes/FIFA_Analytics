...
h1 <- ggcorr( fifa.gk[c(13,11,12,32,33,34,35,36,37)], label = TRUE, label_size = 3, hjust = 1, layout.exp = 2)
h2 <- ggcorr(fifa.def[c(13,11,12,32,33,34,35,36,37)], label = TRUE, label_size = 3, hjust = 1, layout.exp = 2)
h3 <- ggcorr(fifa.mid[c(13,11,12,32,33,34,35,36,37)], label = TRUE, label_size = 3, hjust = 1, layout.exp = 2)
h4 <- ggcorr(fifa.for[c(13,11,12,32,33,34,35,36,37)], label = TRUE, label_size = 3, hjust = 1, layout.exp = 2)
...
# Defender
mod_Defender_1 <- lm(value_eur ~ overall	+ potential + defending, data = fifa.mod.Train)
mod_Defender_2 <- lm(value_eur ~ overall	+ potential + defending	+ physic, data = fifa.mod.Train)
# Midfielder
mod_Midfielder_1 <- lm(value_eur ~ overall	+ potential + passing	+ dribbling + shooting, data = fifa.mod.Train)
mod_Midfielder_2 <- lm(value_eur ~ overall	+ potential + passing	+ dribbling, data = fifa.mod.Train)
mod_Midfielder_3 <- lm(value_eur ~ overall	+ potential + passing, data = fifa.mod.Train)
# Forward
mod_Forward_1 <- lm(value_eur ~ overall	+ potential+ shooting + dribbling, data = fifa.mod.Train)
mod_Forward_2 <- lm(value_eur ~ overall	+ potential+ shooting, data = fifa.mod.Train)
mod_Forward_3 <- lm(value_eur ~ overall	+ potential+ dribbling, data = fifa.mod.Train)
